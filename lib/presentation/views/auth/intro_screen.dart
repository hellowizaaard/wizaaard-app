...
class IntroPage extends StatefulWidget {
  ...
  @override
  _IntroPageState createState() => _IntroPageState(userPrefsManager);
}

class _IntroPageState extends State<IntroPage> {
  final UserPrefsManager userPrefsManager;

  _IntroPageState(this.userPrefsManager);
  ...
  final List<PageViewModel> pages = [
    PageViewModel(
      ...
      decoration: const PageDecoration(
          ...
          pageMargin: EdgeInsets.only(left: 20, right: 20),
  ...
  Widget build(BuildContext context) {
    return clicked
        ? LoginScreen(userPrefsManager: userPrefsManager)
        : IntroductionScreen(
            pages: pages,
            onDone: () {
              afterIntroComplete();
